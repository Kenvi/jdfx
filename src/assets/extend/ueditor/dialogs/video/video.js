...
(function(){
    ...
    function createPreviewVideo(url){
        ...
        // $G("preview").innerHTML = '<div class="previewMsg"><span>仅支持腾讯链接</span></div>'+
        ...
        // '<video class="previewVideo video-js"  controls="controls"  width="' + 420 + '" height="' + 280 + '" src="' + conUrl + '" data-setup="{}">' +
        //     '<source src="' + conUrl + '" type="video/' + ext + '" />'+
        // '</video>';

        // '<iframe frameborder="0" width="'+420+'" height="'+280+'" src="'+conUrl+'" allowfullscreen></iframe>';
    }        
